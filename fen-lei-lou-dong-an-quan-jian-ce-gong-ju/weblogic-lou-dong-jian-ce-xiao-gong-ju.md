---
description: 快速检测weblogic漏洞的工具
---

# WebLogic漏洞检测小工具

源工具链接：[https://github.com/rabbitmask/WeblogicScan](https://github.com/rabbitmask/WeblogicScan)

## weblogicScaner

简体中文 \| [English](https://github.com/FunctFan/weblogicScanner/blob/master/README_EN.md)
...
```text
(venv) ~/weblogicScanner$ python3 ws.py -t 192.168.124.129
